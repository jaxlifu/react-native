/**
 *http://www.ohwonews.com/wp-content/uploads/2015/06/14343242335276.jpg
 *
 */
      ...
      <View style={{}}>
        <View style={[styles.height160, styles.row,]}>
            <View style={[styles.height160, styles.part_1_left,]}>
              ...
              <Image style={[styles.yue]} source={{uri: 'https://p0.meituan.net/mmc/fe4d2e89827aa829e12e2557ded363a112289.png'}}></Image>
            </View>
            <View style={[styles.height160, styles.part_1_right,]}>
              <View style={[styles.row, {flex:1}]}>
                ...
                <View style={[{flex:1}, {marginTop:-13}]}>
                  <Image style={[styles.hanbao]} source={{uri: 'https://p0.meituan.net/mmc/a06d0c5c0a972e784345b2d648b034ec9710.jpg'}}></Image>
                </View>
              </View>
              <View style={[{flex:1, flexDirection: 'row',borderTopWidth:0.5, borderColor:'#DDD8CE'}]}>
                <View style={{flex:1, borderRightWidth:1, borderColor:'#DDD8CE',}}>
                    ...
                    <Image style={{height:25,width:25, alignSelf: 'center'}} source={{uri: 'https://p1.meituan.net/mmc/08615b8ae15d03c44cc5eb9bda381cb212714.png'}}></Image>
                </View>
                <View style={{flex:1,}}>
        ...
        <View>
          <View style={{borderBottomWidth:1,borderTopWidth:1, borderColor:'#DDD8CE', marginTop:40,height:65, flexDirection: 'row',paddingTop:10}}>
            ...
            <View style={{flex:1}}>
                <Image style={{height:50, width:120}} source={{uri:'https://p1.meituan.net/280.0/groupop/7f8208b653aa51d2175848168c28aa0b23269.jpg'}}></Image>
            </View>
          </View>
        </View>
        <View>
          <View style={{flexDirection: 'row',}}>
            <View style={[styles.row, {borderColor:'#DDD8CE', borderRightWidth:1}]}>
              ...
              <View style={{flex:1}}>
                <Image style={{width:60,height:55}} source={{uri: 'https://p1.meituan.net/280.0/groupop/fd8484743cbeb9c751a00e07573c3df319183.png'}}></Image>
              </View>
            </View>
            <View style={styles.row}>
              ...
              <View style={{flex:1}}>
                <Image style={{width:60,height:55}} source={{uri: 'https://p0.meituan.net/280.0/groupop/ba4422451254f23e117dedb4c6c865fc10596.jpg'}}></Image>
              </View>
            </View>
          </View>
          <View style={{flexDirection: 'row',}}>
            <View style={[styles.row, {borderColor:'#DDD8CE', borderRightWidth:1,  marginLeft:1},]}>
              ...
              <View style={{flex:1}}>
                <Image style={{width:60,height:55}} source={{uri: 'https://p0.meituan.net/280.0/groupop/6bf3e31d75559df76d50b2d18630a7c726908.png'}}></Image>
              </View>
            </View>
            <View style={styles.row}>
              <View style={{flex:1}}>
              ...
              <View style={{flex:1}}>
                <Image style={{width:60,height:55}} source={{uri: 'https://p1.meituan.net/mmc/a616a48152a895ddb34ca45bd97bbc9d13050.png'}}></Image>
              </View>
            </View>
          </View>
        </View>
